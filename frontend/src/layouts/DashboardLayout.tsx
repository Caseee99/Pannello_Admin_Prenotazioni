                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            {role === 'agency' && agencyName ? (
                                <>
                                    <span className="text-xs font-medium text-blue-200 leading-tight">Benvenuto/a</span>
                                    <span className="text-xl font-bold tracking-tight text-white leading-tight">{agencyName}</span>
                                </>
                            ) : (
                                <>
