...
import { UserPlus, Settings, Users, Loader2 } from 'lucide-react';
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                ...
                                {drivers.length === 0 && (
                                    <tr><td colSpan={6} className="px-6 py-12 text-center text-gray-400">Nessun autista registrato</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="w-24">
                                    ...
                                    <input 
                                        ...
                                        onChange={e => setNewDriver({ ...newDriver, seats: parseInt(e.target.value) || 4 })} 
                                        placeholder="4"
                                        title="Posti Auto"
                                    />
                                </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="w-24">
                                    ...
                                    <input 
                                        ...
                                        max="9" 
                                        className="w-full border rounded p-2 text-center" 
                                        value={editingDriver.seats || 4} 
                                        onChange={e => setEditingDriver({ ...editingDriver, seats: parseInt(e.target.value) || 4 })} 
                                        placeholder="4"
                                        title="Posti Auto"
                                    />
                                </div>
